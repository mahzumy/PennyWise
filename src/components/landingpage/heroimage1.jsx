        ...
        <section class="bg-white dark:bg-gray-900 pt-10 sm:pt60">
            <div className='grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 space-y-20'>
                <div class="mr-auto place-self-center lg:col-span-7">
                    <h1 class="max-w-xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white">Being <span class="text-blue-600 dark:text-blue-500">wise</span> for every <span class="text-blue-600 dark:text-blue-500">penny.</span></h1>
