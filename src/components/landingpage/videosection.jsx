    ...
    <div className='bg-blue-600'>
        <div className='m bg-blue-600 max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 space-y-20'>
            ...
            <div className='space-y-4'>
                ...
                <p className='text-xl w-3/4'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Dolorem expedita eligendi ipsa error adipisci, veniam id quasi iusto corporis earum nihil tenetur blanditiis laboriosam quibusdam molestias similique hic? Expedita, iste?</p>
            </div>
