  ...
  return (
    <div className=''>
        <section className='bg-white dark:bg-gray-900'>
            <div className='sm:inline md:grid max-w-screen-xl items-center mx-2 md:mx-auto justify-center lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12'>
                <div className='lg:mt-0 sm:col-auto lg:col-span-5 lg:flex sm:px-5 md:mx-0 justify-center content-center'>
                    <img src="asset/pennywise-iphone-mockup.png" alt="mockup" className='sm: w-52 md:max-w-xs' />
                </div> 
                <div className='mx-auto justify-center sm:inline-block lg:col-span-7'>
