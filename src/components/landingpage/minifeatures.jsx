    ...
    <div className='py-20'>
        <div className=' flex max-w-screen-xl px-4 py-8 gap lg:gap-8 xl:gap-0 lg:py-16 mx-auto'>
            <div className='sm:inline-block md:flex w-screen'>
                <div className=' items-center px-10 pb-24 sm:border-none md:border-r md:border-b border-blue-600 w-fit space-y-4'>
                ...
                <div className=' items-center px-10 pb-24 sm:border-none md:border-r md:border-b border-blue-600 w-dit space-y-4'>
